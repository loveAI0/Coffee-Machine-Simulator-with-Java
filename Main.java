...
public class Main{
    ...
    static void estimationOfServing(){
        ...
        if(coffeeAvailable == coffeeNeed){
            System.out.println("Yes, I can make that amount of coffee");
        }
        else if(coffeeAvailable > coffeeNeed){
            System.out.println(String.format("Yes, I can make that amount of coffee (and even %.0f more than that)", coffeeAvailable - coffeeNeed));
        }

        else{
            System.out.println(String.format("No, I can make only %.0f cup(s) of coffee", coffeeAvailable));
        }
